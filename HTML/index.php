...
<body>
    ...
    <div class="container_ads">
      ...
      <div class="testimonial">
        <div class="slide_row" id="slide">
          ...
          <div class="divAds">
            <img class="img_ads" src="https://savani.vn/images/products/cat/2023/12/original/banner-danh-muc-nu_1702872830.webp" alt="">
          </div>
      ...
      <div class="show_product">
        ...
        <div class="notSpill">
          <div class="show_row" id="one_col">
            <div class="show_col">
              <div class="cate_img">
                <a href="./product/giay-dep_male.php"><img class="img_show" src="https://giaycaosmartmen.com/wp-content/uploads/2020/12/cach-chup-giay-dep-5.jpg" alt=""></a>
              </div>
              <div class="cate_text">
                <a href="./product/giay-dep_male.php">Giày & dép</a>
              </div>
            </div>

            <div class="show_col">
              <div class="cate_img">
                <a href="./product/mu-non_male.php">
                  <img class="img_show" src="https://bizweb.dktcdn.net/100/329/281/products/10354059929-1510934832-copy.jpg?v=1569992795683" alt="">
                </a>
              </div>
              <div class="cate_text">
                <a href="./product/balo_male.php">Mũ & nón</a>
              </div>
            </div>

            <div class="show_col">
              <div class="cate_img">
                <a href="./product/quan-ao_male.php">
                  <img class="img_show" src="https://media.canifa.com/Simiconnector/simicategory_filename_tablet1629470033.webp" alt="">
                </a>
              </div>
              <div class="cate_text">
                <a href="./product/quan-ao_male.php">Quần & áo</a>
              </div>
            </div>

            <div class="show_col">
              <div class="cate_img">
                <a href="./product/balo_male.php">
              ...
              <div class="cate_text">
                <a href="./product/balo_male.php">Balô</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="trademark_fash">
    <h2 class="header_trade">THƯƠNG HIỆU NỔI BẬT</h2>
