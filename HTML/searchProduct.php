...
<body>
    ...
    <div class="container" style="margin-top: 100px">
        <?php if (isset($searches)) { ?>
            <div class="h3 ms-2 mt-2" style="margin-top: 40px;">Kết quả tìm kiếm: </div>
            <div class="row row-cols-auto mt-5 mb-5 justify-content-flex-start gap-3" style="padding: 0px 10px;">
                <?php foreach ($searches as $product) { ?>
                    <div class="card col product" style="width: 18rem; padding:0px;">
                        <img style="display:block; width:100%;" src="<?php echo htmlspecialchars($product['image']); ?>" alt="">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($product['pro_name']); ?></h5>
                            <h6 class="card-subtitle mb-5 text-muted">
                                Giá: <?php echo htmlspecialchars($product['price_sell']); ?> VNĐ
                            </h6>
                            <a class="btn btn-primary button-detail " href="./product/product_detail.php?id=<?php echo $product['pro_id']; ?>" role="button">Chi tiết</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
        <?php } else { ?>
            <div class="container" style="padding-top: 40px;text-align:center;font-size:21px">Không tìm thấy kết quả</div>
        <?php } ?>
    </div>
</body>
