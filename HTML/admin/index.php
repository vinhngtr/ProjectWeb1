...
$sql_1 = 'SELECT * FROM accounts WHERE is_admin = 0';
$result = mysqli_query($conn, $sql);
$result_1 = mysqli_query($conn, $sql_1);
// echo $count_user;
$num_orders = mysqli_num_rows($result);
$num_users = mysqli_num_rows($result_1);
...
<body>
    ...
    <?php } else { ?>
        ...
        <div class="d-flex">
            ...
            <div class="ms-2">
                <div class="h4 mb-3 mt-3 text-primary">Dashboard</div>
                <div class="row">
                    <!-- Tổng thu nhập -->
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Tổng thu nhập</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $income ?> đ</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Tiền lãi</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $profit ?> đ</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                            Số đơn hàng</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $num_orders ?></div>
                                    </div>
                                    <div class="col-auto">
