        ...
        <div class="d-flex">
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 260px; background-color: #e3f2fd;">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="comment.php" class="nav-link active" aria-current="page">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $accounts[0]['firstName'] . ' ' . $accounts[0]['lastName'] ?></td>
                                                    <td><?= $comment['cmt_content'] ?></td>
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="../product/product_detail.php?id=<?= $products[0]['pro_id']; ?>">View</a>
